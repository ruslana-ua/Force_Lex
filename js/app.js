    ...
    (() => {
        ...
        if (window.matchMedia("(min-width: 991.98px)").matches) {
            function initSliders() {
                if (document.querySelector(".swiper")) new swiper_core_Swiper(".publications-block__slider", {
        ...
        if (window.matchMedia("(max-width: 991.98px)").matches) {
            ...
            const langRadios = document.querySelectorAll('.language-mob input[name="select_language-mob"]');
            if (currentURL.includes("/en")) {
                langRadios[0].checked = false;
                langRadios[1].checked = true;
                langRadios[2].checked = false;
            } else if (currentURL.includes("/ru")) {
                langRadios[0].checked = false;
                langRadios[1].checked = false;
                langRadios[2].checked = true;
            } else if (!currentURL.includes("/en") && !currentURL.includes("/ru")) {
                langRadios[0].checked = true;
                langRadios[1].checked = false;
                langRadios[2].checked = false;
            }
        }
        ...
        function init() {
            ...
            if (!isFirstVisit) {
                setTimeout(simulateButtonClick, 6e3);
                localStorage.setItem("isFirstVisit", "true");
            } else setTimeout(simulateButtonClick, 3e4);
        }
